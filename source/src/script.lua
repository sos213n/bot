...
{{text = '𓄼• مالك الجروب •𓄹', url = 't.me/'..owner.username}},
{{text = Get_Chat.title, url = Info_Chats.invite_link.invite_link}},
{{text = '♡ اضغط لتنصيب بوتك 🥺♥ˣ.', url = "https://t.me/O_0_Qbot"}},
}}
...
local TextWelcome = (GroupsWelcome or '* ✧ نورت الجروب يا روحي 🥺♥.\n '..(UserInfo.first_name or '---')..'\n '..(Get_Chat.title or '---')..' \n ✧ لازم ياقلبي واحترام الادمنية\n ✧ الالتزام بالقوانين في الوصف\n ✧ الاعضاء '..Info_Chats.member_count..' ⇿ الادمنيه '..Info_Chats.administrator_count..' \n ✧ وقت    انضمامك ي روحي ⇿『 '..os.date("%H:%M:%S *")..' 』\n ✧ تاريخ انضمامك ي روحي ⇿『 '..os.date("%Y/%m/%d *")..' 』*\n')
local reply_markup = bot.replyMarkup{type = 'inline',data = {
{{text = '𓄼• مالك الجروب •𓄹', url = 't.me/'..owner.username}},
{{text = Get_Chat.title, url = Info_Chats.invite_link.invite_link}},
{{text = '♡ اضغط لتنصيب بوتك 🥺♥ˣ.', url = "https://t.me/O_0_Qbot"}},
...
local tecxt = ListMembers.."\n® المشرف {["..names.." ](tg://user?id="..msg.sender_id.user_id..")}".."\® هناك عمليه تخريب وطرد الاعضاء , ليست لدي صلاحيه اضافه مشرفين لتنزيله"
send(msg_chat_id,msg_id,tecxt,"md")
end
end
Redis:del(Fast.."qdelmembars"..msg.chat_id..msg.sender_id.user_id)
...
if idephoto then
local Bot_Name = (Redis:get(Fast.."Name:Bot") or "روسيا")
